...
print_starting_config(sim_id, use_gui, net_filename, route_filename, opt_options, total_vehicles, sumo_version)
...
while vehicles_arrived < total_vehicles and step < max_steps:
    ...
    for veh_id in traci.simulation.getDepartedIDList():
        traci.vehicle.subscribe(veh_id, [tc.VAR_ROAD_ID, tc.VAR_CO2EMISSION, tc.VAR_POSITION, tc.VAR_SPEED, tc.VAR_NOXEMISSION, tc.VAR_FUELCONSUMPTION])
